...
以下原计划已经由 Part 8、9、16、17 和 18 落地：

- Gateway / Agent 日志与运行诊断、账号中心和密码修改、审计筛选/分页、Vue/Vite 工程化、模型控制面、Skill source 状态页、设置页、会话标题、Markdown/代码/数学渲染。
- 通用 Session 全文搜索/归档、知识库、应用市场和定时任务仍不在当前轻量产品范围。

Part 6 只保留最小 Web/API/WS 边界；当前产品界面、交互和构建事实统一以 Part 16 活文档为准。
